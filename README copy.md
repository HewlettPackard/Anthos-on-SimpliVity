...
A Linux host is required for running these Ansible playbooks.  This environment has been tested with Ubuntu 18.04 LTS. The host must be able to communicate to the target vcenter and susequent gke admin host that is created.
...
* Ensure both variable files have been edited to reflect your environment
